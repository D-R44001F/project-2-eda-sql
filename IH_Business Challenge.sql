...
-- by grouping the total_price of each transactions based on `customer_type`.
 
SELECT customer_type, AVG(total_price) AS avg_spent_per_transaction 
FROM supermarket_sales.sales
GROUP BY customer_type;

-- Query #3 result: The results indicate that members spend on average $12 more per transaction than normal customers.
